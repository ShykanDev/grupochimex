...
// dinamyc variable that stores the domain name based on the lenght of the domainName array
const dynamicDomainName = ref(props.website.domainName[0]);

// function to toggle the domainName aleatry based on the length of the domainName array
const toggleDomainName = () => {
  setInterval(() => {
    dynamicDomainName.value = props.website.domainName[Math.floor(Math.random() * props.website.domainName.length)];
  }, 2000);
};
