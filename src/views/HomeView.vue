<template>
  <MainLayout>
    <template #main>
      <article class="w-full bg-slate-100 pt-5">
        <!-- intro -->
        <section class="font-poppins px-8 py-12 bg-gray-50">
          <div class="container mx-auto">
            <h2 class="text-3xl font-semibold text-orange-700 text-center mb-6">
              Somos Grupo Chimex, una empresa con más de 30 años de experiencia en el sector
            </h2>
            <div class="space-y-4">
              <p class="text-gray-700 poppins text-lg leading-relaxed">
        ...
        <!-- Search Bar -->
        <section class="w-full flex justify-center sticky top-20 z-50 mt-4">
...
const websites = ref<Array<IWebsite>>([
  {
    domainName: [
      "www.comercioamerica.com",
      "www.controlcalidad.net",
