  ...
  <div class="flex flex-col min-h-screen">
    ...
    <footer class="px-6 py-8 text-white bg-orange-500 md:px-12">
        ...
        <div>
          ...
          <ul class="space-y-2 text-white">
            ...
            <li class="flex items-center space-x-2">
              ...
              <span>Gutenberg #128 Anzures, Miguel Hidalgo, 11590 Ciudad de México</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <iframe
              ...
              width="600" height="200" style="border:0;" allowfullscreen="false" loading="lazy"
      ...
      <div class="pt-6 text-center borderwhiteder-gray-700 text-gray-50">
        <p>&copy; 2024 Grupo Chimex. Todos los derechos reservados.</p>
